	...
	<footer id="footer" class="clearfix">
		...
		<div id="site-info">
			...
			<ul class="credit">
				...
				<li><?php _e('Proudly powered by', 'meola') ?> <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'meola' ) ); ?>" ><?php _e('WordPress', 'meola') ?></a></li>
				<li><?php printf( __( 'Theme: %1$s by %2$s', 'meola' ), 'Meola', '<a href="https://www.elmastudio.de/en/">Elmastudio</a>' ); ?></li>
			</ul><!-- end .credit -->
			<?php } ?>

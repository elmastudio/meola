...
function load_fonts() {
					wp_register_style('googleFonts', 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,700italic,400,300,700,800');
...
function meola_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'meola_custom_background_args', array(
 ...
 */
function meola_comments_callback($comment, $args, $depth){
...
class meola_flickr extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_flickr', __( 'Meola Flickr', 'meola' ), array(
			'classname'   => 'widget_meola_flickr',
			'description' => __( 'Show your Flickr preview images', 'meola' ),
		) );
	}
	 ...
	 function form($instance) {
		...
		?>
		 ...
		 <p>
				...
				<p>
						<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID:','meola'); ?></label>
...
class meola_image extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_image', __( 'Meola Featured Image', 'meola' ), array(
			'classname'   => 'widget_meola_image',
			'description' => __( 'Show a featured image', 'meola' ),
		) );
	}
...
class meola_about extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_about', __( 'Meola About', 'meola' ), array(
			'classname'   => 'widget_meola_about',
			'description' => __( 'About widget with picture and intro text', 'meola' ),
		) );
	}
...
class meola_video extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_video', __( 'Meola Featured Video', 'meola' ), array(
			'classname'   => 'widget_meola_video',
			'description' => __( 'Show a featured video', 'meola' ),
		) );
	}
...
class meola_recentposts extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_recentposts', __( 'Meola Recent Posts', 'meola' ), array(
			'classname'   => 'widget_meola_recentposts',
			'description' => __( 'Show 3 recent posts with or without thumbnails', 'meola' ),
		) );
	}
...
/*-----------------------------------------------------------------------------------*/
 ...
 class meola_sociallinks extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'meola_sociallinks', __( 'Meola Social Links', 'meola' ), array(
			'classname'   => 'widget_meola_sociallinks',
			'description' => __( 'Link to your social profile sites', 'meola' ),
		) );
	}

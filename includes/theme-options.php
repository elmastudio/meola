			...
			<h3 style="margin-top:30px;"><?php _e( 'Custom Colors', 'meola' ); ?></h3>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Custom Favicon', 'meola' ); ?></th>
					<td>
						...
						<br/><label class="description" for="meola_theme_options[custom_favicon]"><?php _e( 'Create a <strong>16x16px</strong> image and generate favicon using an favicon online generator. Now upload your favicon to your themes folder (via FTP) and enter your Favicon URL here (the URL path should be similar to: yourdomain.com/wp-content/themes/meola/favicon.ico).', 'meola' ); ?></label>
						</fieldset>
					</td>
				</tr>
